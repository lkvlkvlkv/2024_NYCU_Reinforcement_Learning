...
from gymnasium.experimental.wrappers.vector import GrayscaleObservationV0, ResizeObservationV0
...
class AtariDQNAgent(DQNBaseAgent):
	def __init__(self, config):
		...
		### TODO ###
		# initialize env
		self.envs = gym.make_vec(config["env_id"], num_envs=4)
		self.envs = GrayscaleObservationV0(self.envs)
		self.envs = ResizeObservationV0(self.envs, (84, 84))
		self.envs = FrameStack(self.envs, 4)
